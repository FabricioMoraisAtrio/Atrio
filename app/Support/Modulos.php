    ...
    public static function all(): array
    {
        return [
            ...
            'linha-do-tempo' => [
                ...
                'dot'     => '#0062BC',
                'tagline' => 'Vai além do documento: acompanha a evolução real do estudante ao longo do ano.',
            ...
            'laudos' => [
                ...
                'dot'     => '#C0392B',
                'tagline' => 'Os laudos e o mural de observações do estudante, com rastreabilidade.',
                'desc'    => 'Organiza laudos médicos e psicológicos e as observações pedagógicas do estudante, com controle de acesso por perfil.',
                'items'   => [
                    'Upload de laudos com tipo e data',
                    'Identificação por CID e público-alvo da educação especial',
                    'Mural de observações por estudante',
            ...
            'documentos' => [
                ...
                'desc'    => 'Estudo de Caso, PAEE e PEI centralizados por estudante e por ano, com exportação em PDF e Word e registro de cada acesso.',
                'items'   => [
                    'Um documento por tipo, estudante e ano letivo',
