...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .photo-placeholder { width: 90px; height: 90px; border-radius: 6px; border: 1px dashed #ccc; text-align: center; }
    ...
    .sig-role { font-size: 9px; font-weight: bold; color: #444; }
    .sig-name { font-size: 9.5px; color: #1a1a1a; margin-top: 2px; }
    .sig-line { border-bottom: 1px solid #888; display: block; margin-top: 34px; }
