...
@php
    ...
    $metaRow = fn(string $field, string $value = '', string $ph = 'Descreva a meta...') =>
        '<div class="meta-row" style="display:flex;align-items:center;gap:8px;">
            ...
            <button type="button" onclick="removerMeta(this)" style="color:#EF4444;background:none;border:none;cursor:pointer;padding:4px;flex-shrink:0;">
    ...
    <form method="POST" action="{{ route('secretaria.alunos.metas-academicas.update', $aluno) }}">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            @forelse($subjects as $subject)
                ...
                <div class="metas-card" style="background: #fff; border: 1px solid #F3F4F6; border-radius: 12px; overflow: hidden;">
        ...
        <div class="metas-card" style="background: #fff; border: 1px solid #F3F4F6; border-radius: 12px; padding: 18px 20px;">
        ...
        {{-- ─── Metas Funcionais ─── --}}
        <p style="font-size: 11px; font-weight: 700; color: #6D28D9; letter-spacing: 1px; text-transform: uppercase; margin: 24px 0 12px;">Metas Funcionais</p>
        <div class="metas-card" style="background: #fff; border: 1px solid #F3F4F6; border-radius: 12px; padding: 18px 20px;">
