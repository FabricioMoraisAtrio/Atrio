...
<div style="max-width: 560px;">
    ...
    <div style="background: #fff; border-radius: 12px; border: 1px solid #F3F4F6; padding: 28px;">
        <form method="POST" action="{{ route('secretaria.alunos.store') }}" enctype="multipart/form-data">
            ...
            {{-- Laudos --}}
            <div style="border: 1px solid #F3F4F6; border-radius: 10px; padding: 20px; margin-top: 20px;">
                <p style="font-size: 14px; font-weight: 600; color: #111827; margin: 0 0 4px;">{{ term('laudos') }} (opcional)</p>
                <p style="font-size: 12px; color: #9CA3AF; margin: 0 0 16px;">Anexe e categorize um {{ strtolower(term('laudo')) }} já na criação do cadastro.</p>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div>
                        ...
                        @error('laudo_tipo')<p style="font-size: 12px; color: #EF4444; margin: 4px 0 0;">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        ...
                        <input type="date" name="laudo_data_laudo" value="{{ old('laudo_data_laudo') }}"
                               style="width: 100%; border: none; border-bottom: 2px solid #E5E7EB; padding: 8px 0; font-size: 14px; color: #111827; outline: none; background: transparent; box-sizing: border-box;"
                               onfocus="this.style.borderColor='#004B8D'" onblur="this.style.borderColor='#E5E7EB'">
                        @error('laudo_data_laudo')<p style="font-size: 12px; color: #EF4444; margin: 4px 0 0;">{{ $message }}</p>@enderror
                    </div>
                </div>
                ...
                <label id="laudo-file-label" style="display: inline-flex; align-items: center; gap: 8px; background: #F3F4F6; padding: 8px 14px; border-radius: 8px; cursor: pointer; font-size: 13px; color: #374151; font-weight: 500;">
                ...
                @error('laudo_arquivo')<p style="font-size: 12px; color: #EF4444; margin: 8px 0 0;">{{ $message }}</p>@enderror
            </div>
