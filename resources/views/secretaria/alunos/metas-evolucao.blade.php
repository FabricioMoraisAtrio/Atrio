@extends('layouts.app')
@section('title', 'Evolução das Metas — ' . $aluno->name)
...
<div style="max-width: 960px;">
    ...
    <div style="margin-bottom: 24px;">
        ...
        <p style="font-size: 13px; color: var(--text-3); margin: 0;">
            Acompanhe o progresso de cada meta do PEI de <strong>{{ $aluno->name }}</strong> ao longo dos quatro bimestres.
        </p>
    </div>
    ...
    <div style="background: var(--bg-card); border: 1px solid var(--border-sub); border-radius: 12px; padding: 22px 24px; margin-bottom: 24px;">
