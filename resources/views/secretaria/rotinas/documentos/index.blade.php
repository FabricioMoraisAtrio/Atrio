@extends('layouts.app')
@section('title', 'Rotina — Documentos')

@section('content')
<div style="margin-bottom: 28px;">
    <h1 style="font-size: 24px; font-weight: 700; color: #111827; margin: 0 0 6px;">Rotina de Documentos</h1>
...
$cards = [
    ...
    [
        'label'       => 'Adequação Curricular',
        'descricao'   => 'Adequações curriculares aplicadas por aluno, turma e componente.',
        'route'       => 'secretaria.rotinas.documentos.adequacao-curricular',
        'cor'         => '#B45309',
        'bg'          => '#FEF3C7',
        'icon'        => '<path d="M4 6h16M4 12h10M4 18h14"/><path d="M18 15l2 2 4-4"/>',
    ],
    [
        'label'       => 'Material de Apoio',
        'descricao'   => 'Materiais e recursos de apoio organizados por aluno ou turma.',
        'route'       => 'secretaria.rotinas.documentos.material-apoio',
        'cor'         => '#065F46',
        'bg'          => '#ECFDF5',
