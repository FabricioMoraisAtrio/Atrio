...
<div style="margin-bottom: 24px;">
    <h1 style="font-size: 22px; font-weight: 700; color: var(--text-1); margin: 0 0 4px;">Documentos</h1>
    <p style="font-size: 13px; color: var(--text-4); margin: 0;">Todos os documentos gerados na escola</p>
</div>
                   ...
                   onmouseout="this.style.background='transparent'">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div>
                            ...
                            <p style="font-size: 12px; color: var(--text-4); margin: 0;">{{ $doc->year }} · {{ $doc->author->name }} · {{ $doc->updated_at->format('d/m/Y') }}</p>
                        </div>
                    </div>
...
@empty
    <div style="background: var(--bg-card); border-radius: 12px; border: 1px solid var(--border-sub); padding: 48px; text-align: center;">
        <p style="font-size: 14px; color: var(--text-4);">Nenhum documento gerado ainda.</p>
    </div>
@endforelse
@endsection