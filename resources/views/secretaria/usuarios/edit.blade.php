...
<div style="max-width: 520px;">
    <div style="margin-bottom: 24px;">
        ...
        <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin: 0;">Editar — {{ $usuario->name }}</h1>
    </div>
    ...
    <div style="background: #fff; border-radius: 12px; border: 1px solid #F3F4F6; padding: 28px;">
        <form method="POST" action="{{ route('secretaria.usuarios.update', $usuario) }}">
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-size: 11px; font-weight: 600; color: #6B7280; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 8px;">Nova senha <span style="color: #CBCBCB; font-weight: 400; text-transform: none; letter-spacing: 0;">(deixe em branco para manter)</span></label>
            ...
            <div style="margin-bottom: 24px;">
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                    ...
                    <span style="font-size: 13px; color: #374151;">Usuário ativo</span>
                </label>
            </div>
            ...
            @if($usuario->hasRole('professor'))
                <div style="border: 1px solid #F3F4F6; border-radius: 10px; padding: 20px; margin-bottom: 20px;">
                    ...
                    <input type="text" name="subject"
                           value="{{ old('subject', $usuario->schoolClasses->first()?->pivot->subject) }}"
