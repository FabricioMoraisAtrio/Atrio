...
<div style="margin-bottom:24px;">
    ...
    <h1 style="font-size:22px;font-weight:700;color:#111827;margin:0;">Editar — {{ $subject->name }}</h1>
</div>
...
<div style="background:#fff;border-radius:12px;border:1px solid #F3F4F6;padding:32px;max-width:560px;">
    ...
    <form method="POST" action="{{ route('secretaria.subjects.update', $subject) }}">
        ...
        <div style="margin-bottom:28px;">
            <label style="display:block;font-size:11px;font-weight:600;color:#6B7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;">Ordem</label>
