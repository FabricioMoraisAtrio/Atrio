...
<div style="max-width: 480px;">
    <div style="margin-bottom: 24px;">
        ...
        <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin: 0;">Nova turma</h1>
    </div>
        ...
        <form method="POST" action="{{ route('secretaria.turmas.store') }}">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Ex: 7º A"
                       style="width: 100%; border: none; border-bottom: 2px solid {{ $errors->has('name') ? '#EF4444' : '#E5E7EB' }}; padding: 8px 0; font-size: 14px; color: #111827; outline: none; background: transparent; box-sizing: border-box;"
            ...
            <div style="margin-bottom: 20px;">
                ...
                @error('shift')<p style="font-size: 12px; color: #EF4444; margin-top: 4px;">{{ $message }}</p>@enderror
            </div>
            ...
            <div style="margin-bottom: 28px;">
                ...
                <input type="number" name="year" value="{{ old('year', date('Y')) }}" min="2020" max="2099"
                       style="width: 100%; border: none; border-bottom: 2px solid #E5E7EB; padding: 8px 0; font-size: 14px; color: #111827; outline: none; background: transparent; box-sizing: border-box;"
                       onfocus="this.style.borderColor='#004B8D'" onblur="this.style.borderColor='#E5E7EB'">
                @error('year')<p style="font-size: 12px; color: #EF4444; margin-top: 4px;">{{ $message }}</p>@enderror
            </div>

            <div style="display: flex; gap: 12px;">
                <button type="submit"
                        style="background: #004B8D; color: white; border: none; padding: 11px 24px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; letter-spacing: 0.5px;">
                    Salvar turma
                </button>
                <a href="{{ route('secretaria.turmas.index') }}"
