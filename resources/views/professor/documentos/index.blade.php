...
<div style="margin-bottom: 24px;">
    <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin: 0 0 4px;">Meus documentos</h1>
    <p style="font-size: 13px; color: #9CA3AF; margin: 0;">Documentos que você criou ou editou</p>
</div>
                   ...
                   onmouseout="this.style.background='transparent'">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div>
                            ...
                            <p style="font-size: 12px; color: #9CA3AF; margin: 0;">{{ $doc->year }} · {{ $doc->updated_at->format('d/m/Y') }}</p>
                        </div>
                    </div>
...
@empty
    <div style="background: #fff; border-radius: 12px; border: 1px solid #F3F4F6; padding: 48px; text-align: center;">
        <p style="font-size: 14px; color: #9CA3AF; margin: 0;">Você ainda não criou nenhum documento.</p>
    </div>
@endforelse
@endsection